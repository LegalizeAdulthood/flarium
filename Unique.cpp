...
CFlarium24View::MExpression* CFlarium24View::ParseExpression( const char* str, int& index )
{
	try
	{
		//
...
CFlarium24View::MExpression* CFlarium24View::ParseOperand( const char* str, int& index )
{
	try
	{
